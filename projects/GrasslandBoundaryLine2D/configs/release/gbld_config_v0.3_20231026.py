...
data_root = '/data-ssd2/liyj/dataset/gbld_2d/glass_edge_overfit_20231025_mmdet3d_split_line'
...
test_line_thinkness = 20      # 测试时绘制线的宽度,在原图大小上进行测试, 这个宽度需要根据输入的size进行调整
test_t_iou = 0.3              # 测试时单个实例的ap阈值
